...
Route::middleware(['languages'])->group(function () {
    ...
    Route::get('/comparar', [Controllers\SolutionsController::class, 'index'])->name('solutions');
    ...
    Route::get('/produtos-detalhes', [Controllers\ProductsController::class, 'detalhe'])->name('products-details');
