                    ...
                    <div class="d-block swiper-slide" data-aos="zoom-out-up">
                        <div class="row mt-lg-4 mt-2">
                            @foreach (range(0,7) as $r)
                                <div class="d-block swiper-slide col-lg-4 col-xl-3 col-md-4 col-sm-6 col-12 mb-2" data-aos="fade-left">
                            ...
                            <ul class="pagination pt-1">
                              <li class="page-item">
                                <a class="page-link" href="#">
                                    <button class="bg-primary rounded-circle d-flex" style="padding: 10px !important;border: none;">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M7 3.00012L2 8.00012M2 8.00012L7 13.0001M2 8.00012L14 8.00012" stroke="white" stroke-linejoin="round"/>
                                        </svg>                                        
                                    </button>                                           
