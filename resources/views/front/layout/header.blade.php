...
<link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap" rel="stylesheet">
 ...
 {{-- blog--}}
<div class="offcanvas offcanvas-start bg-primary" style="background: #3B3A79" tabindex="-1" id="offcanvasExample2" aria-labelledby="offcanvasExampleLabel">
    ...
    <div class="offcanvas-body mt-4">
        @foreach (range(0,3) as $t)
            <div class="col-12 w-100 mt-1">
                <button class="btn btn-orange rounded-5 w-100">
                    Categoria
                </button>
            </div>
        @endforeach
        ...
        <div class="col-12 mt-2">
            <ul class="nav nav-pills mb-3 w-100" id="pills-tab" role="tablist">
                <li class="nav-item col-6" role="presentation">
                  <button style="padding: 10px;" class="nav-link w-100 active rounded-5-left" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Home</button>
                </li>
                <li class="nav-item col-6" role="presentation">
                  <button style="padding: 10px;" class="nav-link w-100 rounded-5-right" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Profile</button>
                </li>
              </ul>
...
<body>
    ...
    <header class="header w-100  isolation-isolate position-absolute w-100 top-0 start-0 w-100 px-2 px-lg-0 {{ !Route::is('home') ? "bg-primary position-relative" : "" }}" data-aos="zoom-out-up">
        <div class="container">
            <div class="row align-items-center py-2 py-lg-2 px-2" style="background-image: url({{ asset('front/images/backgrounds/header.png') }})">
                ...
                {{--<div class="col-lg-7 col-6 me-auto m-lg-auto d-flex justify-content-end justify-content-lg-center">
                    ...
                    <div class="col-lg-6 col-6 ms-auto d-flex align-items-center justify-content-end">
                        <div class="d-flex gap-1">
                            <button class="btn btn-outline-light rounded-5 d-none d-md-block" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
                            ...
                            <button class="ms-1 btn btn-outline-light rounded-5 text-white" style="padding: 5px;" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
                    ...
                    <div class="col-lg-6 col-12 d-flex align-items-center justify-content-center d-md-none">
                        <div class="mt-2">
                            <button class="btn btn-outline-orange rounded-5 d-md-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasExample" aria-controls="offcanvasExample">
                                Busca avançada
                                <svg class="ms-0-50" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9.89445 9.89445L15 15M11.4228 6.21142C11.4228 9.0896 9.0896 11.4228 6.21142 11.4228C3.33323 11.4228 1 9.0896 1 6.21142C1 3.33323 3.33323 1 6.21142 1C9.0896 1 11.4228 3.33323 11.4228 6.21142Z" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
                                </svg>                                    
